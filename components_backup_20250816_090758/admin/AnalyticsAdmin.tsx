...
export default function AnalyticsAdmin() {
  ...
  } = useAdminData<BacktestingResults>('/api/admin/backtesting-results');
  ...
  } = useAdminData<AIVsRandomAnalysis>('/api/admin/ai-vs-random-analysis');
  ...
  } = useAdminData<HistoricalPerformance>(`/api/admin/historical-performance?period=${selectedPeriod}`);
