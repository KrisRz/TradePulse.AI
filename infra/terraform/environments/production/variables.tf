...
# VPC adoption mode and identifiers (existing VPC)
variable "vpc_adoption" {
  description = "VPC management mode: 'existing' or 'managed'"
  type        = string
  default     = "existing"
}

variable "vpc_id" {
  description = "Existing VPC ID (when vpc_adoption = 'existing')"
  type        = string
  default     = ""
}

variable "private_subnet_ids" {
  description = "Existing private subnet IDs for Lambdas (when vpc_adoption = 'existing')"
  type        = list(string)
  default     = []
}

variable "lambda_security_group_id" {
  description = "Existing Lambda security group ID (when vpc_adoption = 'existing')"
  type        = string
  default     = ""
}
