...
export default function MarketInfo({
  ...
  const fetchMarketData = async () => {
    try {
      ...
      const marketResponse = await response.json();
      
      const realMarketData: MarketData = {
        symbol: marketResponse.symbol || symbol,
        price: marketResponse.price || 0,
        priceChange: marketResponse.priceChange || 0,
        priceChangePercent: marketResponse.priceChangePercent || 0,
        high24h: marketResponse.high24h || 0,
        low24h: marketResponse.low24h || 0,
        volume24h: marketResponse.volume24h || 0,
        volumeChange: marketResponse.volumeChange || 0,
        trades24h: marketResponse.trades24h || 0,
